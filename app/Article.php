...
class Article extends Model implements BalanceInterface,FactorInterface
{
    ...
    {
        return env('ARTICLE_PRICE', 5000);
    }

    public function getFactorTitle()
    {
        return __('factor.articleTitle', ['amount' => $this->getInsertFee()]);
    }

    public function getFactorDescription()
    {
        return __('factor.articleDescription');
    }
